...
export type CwlGroupResponse = EndpointResponse<typeof BotCwlGroupEndpoint>;
export type CwlGroupMember = CwlGroupResponse["clans"][number]["members"][number];
export type CwlGroupClan = CwlGroupResponse["clans"][number];
type CwlRoundWar = CwlGroupResponse["rounds"][number]["warTags"][number];
