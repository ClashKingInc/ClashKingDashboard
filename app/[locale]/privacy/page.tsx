      ...
      <div className="container mx-auto px-4 py-24 max-w-4xl">
        ...
        <div className="space-y-8 text-muted-foreground">
          ...
          <section>
            ...
            <p className="mb-4 text-muted-foreground">We do not sell or share your personal data with any third party for advertising, analytics, or marketing purposes. Your data is only used to operate the app and provide its core functionalities.</p>
            <div className="space-y-4">
              <div>
