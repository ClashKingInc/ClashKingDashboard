/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.deploy.jsonc` (hash: ffeea3a0cedd40d94c4bda240b23a01a)
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/dashboard-edge/index");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_API_URL" | "NEXT_PUBLIC_DISCORD_CLIENT_ID">> {}
}
